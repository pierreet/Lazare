...
class remotecontrol_handle
{
  ...
  /**
    ...
    **/
    public function export_responses($sSessionKey, $iSurveyID, $sDocumentType, $sLanguageCode=null, $sCompletionStatus='all', $sHeadingType='code', $sResponseType='short', $iFromResponseID=null, $iToResponseID=null, $aFields=null, $sFilter = '')
    {
        ...
        $oFomattingOptions->responseMaxRecord=10;
        ...
        //$sFileData=$oExport->exportSurvey($iSurveyID,$sLanguageCode,'return',$oFomattingOptions);
		//$sFileData=$oExport->exportSurvey($iSurveyID, $sLanguageCode, 'display', $oFomattingOptions);
		$sFileData=$oExport->exportSurvey($iSurveyID, $sLanguageCode, $sDocumentType, $oFomattingOptions, $sFilter);
        //return $sFileData.'.'.$sDocumentType;
		return $sFileData;
    }
