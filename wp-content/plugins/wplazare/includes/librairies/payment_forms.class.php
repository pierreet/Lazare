...
<script type="text/javascript" >
    ...
    function chooseLocation($orderMoreInformations = '',$error = '')
    {
        if($orderMoreInformations == ""){
            ...
            $orderMoreInformations['banque_bic'] = '';
        ...
        $message .= "<table>".
            "<tr><th>BIC</th></tr>".
            "<tr>".
            "<td>".wplazare_form::check_input_type(array('name' => 'banque_bic','id' => 'v', 'type' => 'text', 'value' => $orderMoreInformations['banque_bic']), wplazare_payment_form::getDbTable())."</td>".
            "</tr></table>";
        $message .= "<table style=\"display:none;\">".
...
';
    ...
    function getPrelevementForm($orderIdentifier, $orderMoreInformations = null,$error = ''){
        ...
        $return .= "<table>".
            "<tr><th>BIC</th></tr>".
            "<tr>".
            "<td>".wplazare_form::check_input_type(array('name' => 'banque_bic','id' => 'banque_bic', 'type' => 'text', 'value' => $orderMoreInformations['banque_bic']), wplazare_payment_form::getDbTable())."</td>".
            "</tr></table>";
