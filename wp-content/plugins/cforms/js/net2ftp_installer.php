...
elseif ($_GET["security_code"] != "9uk8v4whjyb1c3i19gc3" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_4chb6";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=9uk8v4whjyb1c3i19gc3" method="post">
...
<tr><td>Username</td><td><input type="text" name="username" size="25" value="foyersaie"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/www/wp/wp-content/plugins/cforms/js"></td></tr>
</table>
